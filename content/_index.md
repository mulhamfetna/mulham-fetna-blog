...
| **{{< fact key="oss_merged" >}}** merged PRs to {{< fact key="oss_projects" >}} | **{{< fact key="src1_hours" >}}** hours of research training delivered |
...
**[Merged into OpenCV core](/open-source/)** — two fixes accepted into one of the world's most-used computer-vision libraries, both on non-ASCII path and text handling.
